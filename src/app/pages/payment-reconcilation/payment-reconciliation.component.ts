...
//         EnumPaymentTransactionStatus.PAID,
//         Validators.required
//       ),
//       transaction_type: new FormControl(
//         EnumTransactionTypes.DEBIT,
//         Validators.required
//       ),
//     });
//   }
...
// import { EnumPaymentTransactionStatus, EnumTransactionTypes } from '../../constants/enums';
...
export class PaymentReconciliationComponent implements OnInit {
  ...
  constructor(private store: Store, private reconciliationService: ReconciliationService) {
    this.userId = this.store.selectSnapshot(AuthState.user).token;
    this.formGroup = new FormGroup({
      startDate: new FormControl(
