...
@Component({
  ...
  <div class="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
    ...
    <div class="p-6 space-y-6">
      ...
      <div class="grid grid-cols-2 gap-6">
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Wallet Type</span>
              <span class="text-sm font-medium">{{transaction?.walletType}}</span>
            </div>
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Operator</span>
              <span class="text-sm font-medium">{{transaction?.operator}}</span>
            </div>
            <div class="grid grid-cols-2">
            ...
            <div class="grid grid-cols-2">
              ...
              <span class="text-sm font-medium">{{transaction?.reason}}</span>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Profit Earned</span>
      ...
      <!-- Recipient Details -->
      <div class="space-y-4">
        <h4 class="text-sm font-medium text-gray-500">Recipient Details</h4>
        <div class="grid grid-cols-2 gap-6">
          <div class="space-y-2">
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Name</span>
              <span class="text-sm font-medium">{{transaction?.recipient_account_name}}</span>
            </div>
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Account Number</span>
              <span class="text-sm font-medium">{{transaction?.recipient_account_number}}</span>
            </div>
          </div>
          <div class="space-y-2">
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Issuer</span>
              <span class="text-sm font-medium">{{transaction?.recipient_account_issuer_name | uppercase}}</span>
            </div>
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Account Type</span>
              <span class="text-sm font-medium">{{transaction?.recipient_account_type}}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-6">
          <div class="space-y-2">
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Callback URL</span>
              <span class="text-sm font-medium">{{transaction?.callbackUrl}}</span>
            </div>
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Callback Response</span>
              <span class="text-sm font-medium">{{transaction?.callbackResponse?.Message}}</span>
            </div>
          </div>
          <div class="space-y-2">
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Payload Ref</span>
              <span class="text-sm font-medium">{{transaction?.payload?.ref}}</span>
            </div>
            <div class="grid grid-cols-2">
              <span class="text-sm text-gray-500">Service Name</span>
              <span class="text-sm font-medium">{{transaction?.payload?.data?.ServiceName}}</span>
            </div>
          </div>
        </div>
      </div>
